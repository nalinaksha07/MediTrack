...
export const receivePurchase = (id, data) => api.post(`/purchases/${id}/receive`, data);
...
export const runAIAnalysis = (hospitalId) => api.post('/ai/analyze', { hospitalId });
export const updateInsightStatus = (id, status) => api.put(`/ai/insights/${id}/status`, { status });
export const createTransferFromAI = (id) => api.post(`/ai/insights/${id}/create-transfer`);
